      ...
      class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
        ...
        deactivateActiveTab() {
          const e = this.getSettings(),
            ...
            s = "." + t,
            i = this.elements.$tabDropdowns.filter(n),
            o = this.elements.$tabContents.filter(s),
            r = this.elements.$menuContent;
          this.setTabDeactivationAttributes(i),
            o.removeClass(t),
            ...
            elementorFrontend.isEditMode() &&
              o.length &&
              this.observedContainer?.unobserve(o[0]),
            this.menuHeightController.resetMenuHeight(o);
        }
        ...
        onTabClick(e) {
          ...
          if (s !== this.getID().toString()) return;
          const i = this.getSettings("selectors"),
            o = e?.currentTarget,
            r = o?.querySelector(i.tabDropdown),
      ...
      class MenuTitleKeyboardHandler extends elementorModules.frontend.handlers
        ...
        __construct() {
          super.__construct(...arguments),
            (this.focusableElementSelector =
              "audio, button, canvas, details, iframe, input, select, summary, textarea, video, [accesskey], [contenteditable], a[href], area[href], [tabindex]"),
        ...
        getDefaultElements() {
          ...
          return {
            ...
            $menuItemElements: this.findElement(e.menuItemElement),
        ...
        getActiveTitleElement() {
          const e = this.getSettings("ariaAttributes").activeTitleSelector;
          return this.elements.$menuItemElements.filter(e);
        }
        onInit() {
          super.onInit(...arguments);
          let e = 1;
          this.elements.$menuItemElements.each((t, n) => {
        ...
        handleTitleTab(e) {
          ...
          this.maybeFocusMenuToggle(e, t);
          const n = this.getActiveTitleElement(),
            s = t === (this.getTitleIndex(n[0]) || !1),
            i = n.attr(
              this.getSettings("ariaAttributes").titleControlAttribute
            ),
            o = this.elements.$itemContainers.filter(`#${i}`),
            r = 0 !== this.getFocusableElements(o).length;
          s && r
            ? this.focusFirstFocusableContainerElement(e, i)
            : this.closeActiveContentElements();
        }
        maybeFocusMenuToggle(e, t) {
          if (!this.isLastTitle(t) || !this.isDropdownLayout()) return;
          const n = this.getSettings("ariaAttributes").titleStateAttribute,
            s = "true" === e.currentTarget.getAttribute(n),
            i =
              0 !==
              this.getFocusableElements(this.elements.$itemContainers.last())
                .length;
          (s && i) ||
        ...
        handleTitleHomeOrEndKey(e) {
          ...
          const t = this.getTitleIndex(e.currentTarget) || 1,
            n = this.elements.$menuItemElements.length,
        ...
        setTitleFocus(e) {
          this.elements.$menuItemElements
            .filter(this.getTitleFilterSelector(e))
            .trigger("focus");
        }
        isLastTitle(e) {
          return this.elements.$menuItemElements.length === e;
        }
        ...
        handleContentElementKeyboardNavigation(e) {
          switch (e.key) {
            case "Tab":
              const t = e.shiftKey ? "previous" : "next";
              this.handleContentElementTabEvents(e, t);
              break;
            case "Escape":
              e.preventDefault(),
                e.stopPropagation(),
        ...
        handleContentElementTabEvents(e, t) {
          const n = jQuery(e.currentTarget),
            s = this.getSettings("selectors").itemContainer,
            i = n.closest(s),
            o = this.getFocusableElements(i);
          let r;
          r = "previous" === t ? o.first() : o.last();
          if (!n.is(r)) return;
          e.preventDefault();
          const a = this.getActiveTitleElement(),
            l = this.getTitleIndex(a[0]);
          this.setTitleFocus(l), e.stopPropagation();
        }
        handleContentElementEscapeEvents() {
          this.getActiveTitleElement().trigger("focus"),
            this.closeActiveContentElements();
        }
        focusFirstFocusableContainerElement(e, t) {
          const n = `#${t}`,
            s = this.elements.$itemContainers.filter(n),
            i = this.getFocusableElements(s).first();
          0 !== i.length &&
            (e.preventDefault(), i[0]?.focus(), e.stopPropagation());
        }
    ...
    1699: function (e) {
      e.exports = (function () {
        ...
        function createDOMPurify() {
          ...
          let { IS_ALLOWED_URI: ae } = j,
            le = null;
          const de = addToSet({}, [...b, ...w, ...C, ...E, ...F]);
          let ce = null;
          const ue = addToSet({}, [...M, ...k, ...I, ...A]);
          let me = Object.seal(
              Object.create(null, {
                tagNameCheck: {
                  writable: !0,
          ...
          let je = Ne,
            Re = !1,
            ze = null;
          const qe = addToSet({}, [Be, We, Ne], g);
          let Ue;
          const Ve = ["application/xhtml+xml", "text/html"],
            Qe = "text/html";
          let Ge,
            Ke = null;
          const Ye = i.createElement("form"),
              ...
              if (!Ke || Ke !== e) {
                if (
                  ...
                  Ae &&
                    ((le = addToSet({}, [...F])),
                    (ce = []),
                    !0 === Ae.html && (addToSet(le, b), addToSet(ce, M)),
                    !0 === Ae.svg &&
                      (addToSet(le, w), addToSet(ce, k), addToSet(ce, A)),
                    !0 === Ae.svgFilters &&
                      (addToSet(le, C), addToSet(ce, k), addToSet(ce, A)),
                    !0 === Ae.mathMl &&
                      (addToSet(le, E), addToSet(ce, I), addToSet(ce, A))),
                  e.ADD_TAGS &&
                    (le === de && (le = clone(le)),
                  ...
                  e.FORBID_CONTENTS &&
                    (xe === De && (xe = clone(xe)),
                    addToSet(xe, e.FORBID_CONTENTS, Ge)),
                  ke && (le["#text"] = !0),
          ...
          const it = function _checkValidNamespace(e) {
            ...
            at = function _initDocument(e) {
              ...
              if (!t || !t.documentElement) {
                t = G.createDocument(je, "template", null);
                try {
            ...
            ht = function _isValidAttribute(e, t, n) {
              if (Te && ("id" === t || "name" === t) && (n in i || n in Ye))
                return !1;
              if (fe && !ge[t] && y(se, t));
              else if (pe && y(ie, t));
              else if (!ce[t] || ge[t]) {
          ...
          return (
            (DOMPurify.sanitize = function (e) {
              ...
              if (Ce) {
                if ($e)
                  for (o = Y.call(t.ownerDocument); t.firstChild; )
              ...
              return (
                Se &&
                  ...
                  y(N, t.ownerDocument.doctype.name) &&
