            ...
            h = (function () {
              ...
              return (
                ...
                (e.prototype.dispose = function () {
                  t.removeData(this._element, "htbbs.htb-alert"),
                    (this._element = null);
                }),
                ...
                (e._jQueryInterface = function (n) {
                  return this.each(function () {
                    ...
                    o || ((o = new e(this)), i.data("htbbs.htb-alert", o)),
                      "htb-close" === n && o[n](this);
                  });
                }),
        ...
        (function (t) {
          var e = "htb-button",
            ...
            a = {
              ...
              FOCUS_BLUR_DATA_API:
                "htb-focus.htbbs.htb-button.data-api blur.htbbs.htb-button.data-api",
            },
            l = (function () {
              function e(t) {
                n(this, e), (this._element = t);
              ...
              return (
                ...
                (e.prototype.dispose = function () {
                  t.removeData(this._element, "htbbs.htb-button"),
                    (this._element = null);
                }),
                (e._jQueryInterface = function (n) {
                  return this.each(function () {
                    ...
                    i ||
                      ((i = new e(this)), t(this).data("htbbs.htb-button", i)),
                      "toggle" === n && i[n]();
                  });
                }),
                o(e, null, [
        ...
        (function (t) {
          var e = "htb-modal",
            ...
            d = {
              ...
              FIXED_CONTENT:
                ".htb-fixed-top, .htb-fixed-bottom, .htb-is-fixed, .htb-sticky-top",
            ...
            f = (function () {
              ...
              return (
                ...
                (a.prototype.dispose = function () {
                  t.removeData(this._element, "htbbs.htb-modal"),
          ...
          t(document).on(c.CLICK_DATA_API, d.DATA_TOGGLE, function (e) {
            ...
            o && (i = t(o)[0]);
            var s = t(i).data("htbbs.htb-modal")
              ? "toggle"
              ...
              return (
                ...
                (e._jQueryInterface = function (n) {
                  return this.each(function () {
                    ...
                    if (
                      (o || ((o = new e(this)), i.data("htbbs.htb-tab", o)),
                      "string" == typeof n)
                    ) {
                      if (void 0 === o[n])
        ...
        (function (t) {
          ...
          var e = "htbtooltip",
            ...
            u = {
              animation: !0,
              template:
                '<div class="htb-tooltip" role="tooltip"><div class="htb-arrow"></div><div class="htb-tooltip-inner"></div></div>',
              trigger: "hover focus",
              title: "",
              delay: 0,
              html: !1,
              ...
              return (
                ...
                (a.prototype._setListeners = function () {
                  ...
                  this.config.trigger.split(" ").forEach(function (n) {
                    ...
                    t(e.element)
                      .closest(".htb-modal")
                      .on("hide.htbbs.htb-modal", function () {
                        return e.hide();
                      });
                  }),
    ...
    !(function (r) {
      var a = "htbpopover",
        ...
        u = r.extend({}, s.Default, {
          ...
          content: "",
          template:
            '<div class="htb-popover" role="tooltip"><div class="htb-arrow"></div><h3 class="htb-popover-header"></h3><div class="htb-popover-body"></div></div>',
        }),
            ...
            (h._jQueryInterface = function (t) {
              return this.each(function () {
                ...
                if (
                  ...
                  (e ||
                    ((e = new h(this, n)), r(this).data("htbbs.popover", e)),
                  "string" == typeof t)
                ) {
                  if (void 0 === e[t])
